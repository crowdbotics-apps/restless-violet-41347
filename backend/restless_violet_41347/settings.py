"""
Django settings for restless_violet_41347 project.
...
ROOT_URLCONF = 'restless_violet_41347.urls'
...
WSGI_APPLICATION = 'restless_violet_41347.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_violet_41347 API",
    "DESCRIPTION": "API documentation for restless_violet_41347 App",
    "VERSION": "v1",
}
